...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    mysqli_query($connect, "DELETE FROM `product` WHERE category_id = '$category_id' ") or mysqli_error($connect);

    mysqli_query($connect, "DELETE FROM `category` WHERE category_id = '$category_id' ") or mysqli_error($connect);

    


    $deleted = "You have successfully deleted this brand..";
    }
else
    {
