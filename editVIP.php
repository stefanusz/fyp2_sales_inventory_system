...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $query = "SELECT * FROM customer WHERE vip_id = $vip_id";
    ...
    $vipform = "<form enctype='multipart/form-data' action='doEditVip.php' method=POST name='editVip'>
 
    <table width=473 border=0 cellpadding=10 cellspacing=2>
    

<input type='hidden' value='$vip_id' name='vip_id'>
           ...
           <tr>
            ...
            <tr>
              ...
              <td width=275><input type='text' name ='last_name' id=last_name value='$last_name' /></td>
            </tr>
        
            <tr>
              <td width=70 height=57><font  size=2.5>Email Address:</font></td>
              <td width=275><input type='text' name ='email_add' id=email_add value='$email_add' /></td>
            </tr>
        
            <tr>
              <td width=70 height=57><font  size=2.5>Contact No:</font></td>
              <td width=275><input type='text' name ='contact_no' id=contact_no value='$contact_no' /></td>
            </tr>
