        ...
        <div id="wrapper">
           ...
           <div id="menu">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Choosing the duration of payment made type.</a></h1>
...
echo "<form enctype='multipart/form-data' action='doChoosePaymentType.php' method=POST name='postdate' >
