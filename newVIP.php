...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $VIPform = "<form enctype='multipart/form-data' action='doNewVip.php' method=POST name='addVIP'>
    ...
    <table width=473 border=0 cellpadding=10 cellspacing=2>
		...
		<td><input type='text' name='last_name' id=last_name /></td>
            ...
            <tr>
              <td width=70 height=57><font  size=2.5>Contact Number:</font></td>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new VIP membership.</a></h1>
