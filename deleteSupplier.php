...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    mysqli_query($connect, "DELETE FROM `resolvecategory` WHERE supplier_id = '$supplier_id' ") or mysqli_error($connect);

    mysqli_query($connect, "DELETE FROM `supplier` WHERE supplier_id = '$supplier_id' ") or mysqli_error($connect);

    


    $deleted = "You have successfully deleted this supplier.";
    }
else
    {
