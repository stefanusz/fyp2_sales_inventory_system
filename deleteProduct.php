...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    mysqli_query($connect, "DELETE FROM `stockupdate` WHERE product_id = '$product_id' ") or mysqli_error($connect);

    mysqli_query($connect, "DELETE FROM `product` WHERE product_id = '$product_id' ") or mysqli_error($connect);


    $deleted = "You have successfully deleted this product.";
    }
else
    {

    $notadmin = "You have to be an admin to do this.";
    }
?>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Delete a Product.</a></h1>
