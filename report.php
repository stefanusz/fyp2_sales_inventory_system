    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Viewing all the the different reports available to you.</a></h1>
         ...
         if(($_SESSION['role'] == 'admin') || ($_COOKIE['role'] == 'admin'))
             {
                  $list = "<ul>
                              <br/>
                               <li><a href='chooseSales.php'>View Sales that happened.</a></li><br/>
                               <br/>
                               <li><a href='chooseRevenue.php'>View Revenue Earned.</a></li><br/>
                               <li><a href='chooseConsignment.php'>View payment to Supplier.</a></li><br/>
                               <li><a href='choosePaymentType.php'>View payment to Banks.</a></li>
                               <br/><br/>
                               <li><a href='choosePopularSupplier.php'>View Popular Supplier.</a></li><br/>
                               <li><a href='choosePopularBrand.php'>View Popular Brand.</a></li><br/>
                               <li><a href='choosePopularProduct.php'>View Popular Product.</a></li><br/>
                               <li><a href='choosePNL.php'>Print PNL.</a></li>
            ...
            {
             $notadmin = "You are not an admin and not authorize to do this!";
             echo $notadmin;
            }
    }
    else
