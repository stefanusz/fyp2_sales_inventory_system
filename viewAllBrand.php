        ...
        <div id="wrapper">
           ...
           <div id="menu">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Viewing all the different brands..</a></h1>

                        <div class="entry">
                            <p>
                                Below are all the different Brands..<br/>
...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    $header = "<tr>
              <td width=70 height=57><font  size=2.5>Brand ID:</font></td>
              <td width=70 height=57><font  size=2.5>Brand Name:</font></td>
    ...
    while ($runrows = mysqli_fetch_array($runquery))
        ...
        echo $brandList = "<tr>
                       <td width=70 height=57><font  size=2.5>$category_id</font></td>
                       <td width=70 height=57><font  size=2.5>$brand_name</font></td>
                       <td width=70 height=57><font  size=2.5><a href =editBrand.php?category_id=$category_id >Update this. </a></font></td>
                       <td width=70 height=57><font  size=2.5><a href =deleteBrand.php?category_id=$category_id onclick='return confirmDelete()' >Delete this. </a></font></td>
