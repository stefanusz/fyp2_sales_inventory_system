...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    if ($submit)
        ...
        echo $chooseform = "<form enctype='multipart/form-data' action='chooseProduct.php' method=POST name='chooseProduct'>
    ...
    ";
        ...
        $headertable = "<table border= '0' cellpadding='4' cellspacing='0'>
                                            <tr>
                                            <th>Choose the product that you want to enter below.</th>
        ...
        $result = "<input type='hidden' value=$category_id name='category_id'>
    
                    <tr>
                    <td><a href =newBags.php?category=$category_id >Click here to enter a new bag. </a></td>
                    </tr>
    
                    <tr>
                    <td><a href =newClothes.php?category=$category_id >Click here to enter a new clothes. </a></td>
                    </tr>
    
                    <tr>
                    <td><a href =newAccessories.php?category=$category_id >Click here to enter a new accessory. </a></td>
                    </tr>
                    
                    <tr>
                    <td><a href =newVintage.php?category=$category_id >Click here to enter a new vintage dress. </a></td>
                    </tr>
    ";
        echo $result;
