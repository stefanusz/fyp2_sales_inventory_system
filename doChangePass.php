<?php
	...
	if (isset($_SESSION['username']) || isset($_COOKIE['username']))
	    ...
	    if (isset($_SESSION['username']))
	        ...
	        $dologout = "<a href='changepass.php'> Click here to change password. </a><br/><br/>
	            <a href='dologout.php'> Click here to Log out </a><br/>";
	        }
	    else
	        {
	...
	if ($submit) //check the new passwords if it fits our password restrictions.
	{
	    if (isset($_SESSION['username']) || $_COOKIE['username'])
	    {
	        ...
	        $passwordsql = "SELECT password FROM user WHERE username = '$username' ";
	        ...
	        else //update new password into database
	        {
	            ...
	            {
	                mysqli_query($connect, "UPDATE  `user` SET `password` = SHA1('$password') WHERE username = '$username' ") or die(mysqli_error($connect));
