        ...
        <div id="wrapper">
           ...
           <div id="menu">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Choosing the duration of Sales that happened.</a></h1>
...
echo "<form enctype='multipart/form-data' action='doChooseSales.php' method=POST name='postsale' >
