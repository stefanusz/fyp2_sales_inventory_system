...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Managing VIP members in Dulcetfig.</a></h1>
    ...
    if((isset($_COOKIE['username'])) || (isset ($_SESSION['username'])))
    {
                   ...
                   $list = "<ul>
                                <li><a href='viewAllvip.php'>View all the VIP members.</a></li><br/>
                                <li><a href='newVIP.php'>Enter new VIP Member.</a></li><br/>
                                <li><a href='updateVIP.php'>Search a VIP.</a></li>
