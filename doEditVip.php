...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    {
        ...
        if ($submit)
            ...
            $vip_id = mysqli_real_escape_string($connect, strip_tags($_POST['vip_id']));
            $first_name = mysqli_real_escape_string($connect, strip_tags($_POST['first_name']));
            $last_name = mysqli_real_escape_string($connect, strip_tags($_POST['last_name']));
            $email_add = mysqli_real_escape_string($connect, strip_tags($_POST['email_add']));
            ...
            mysqli_query($connect, "UPDATE  `customer` SET  `first_name` =  '$first_name', `last_name` =  '$last_name', `email_add` =  '$email_add', `contact_no` =  '$contact_no' WHERE `vip_id` = '$vip_id' ") or die(mysql_error());


            $success = "You succesfully update this VIP member!";
