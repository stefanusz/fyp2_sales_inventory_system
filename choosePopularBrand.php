        ...
        <div id="wrapper">
           ...
           <div id="menu">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Choosing the date for popular brand.</a></h1>
...
echo "<form enctype='multipart/form-data' action='doChoosePopularBrand.php' method=POST name='postdate' >
