...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Expenditure.</a></h1>
    ...
    if((isset($_COOKIE['username'])) || (isset ($_SESSION['username'])))
    {
         if(($_SESSION['role'] == 'admin') || ($_COOKIE['role'] == 'admin'))
             {
                  $list = "<ul>
                               <li><a href='viewAllExpenditure.php'>View all monthly expenditure.</a></li><br/>
                               <li><a href='newExpenditure.php'>Enter a new expenditure.</a></li><br/>
                               <li><a href='ViewAllPayment.php'>View all the different card payment amount.</a></li><br/>
                               <li><a href='newDiscount.php'>Enter a new discount / promotion.</a></li><br/>
                               <li><a href='viewAllDiscount.php'>View all the different discount / promotion.</a></li>
