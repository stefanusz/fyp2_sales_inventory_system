...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    $discountform = "<form enctype='multipart/form-data' action='doNewDiscount.php' method=POST name='adddiscount'>
 
    <table width=650 border=0 cellpadding=10 cellspacing=2>
		
            <tr>
              <td width=70 height=57><font  size=2.5>Discount / Promo Name:</font></td>
              <td width=275><input type='text' name ='promotion_name' id=promotion_name /></td>
            </tr>
			
            <tr>
              <td width=70 height=57><font  size=2.5>Discount / Promo Description:</font></td>
              <td><textarea rows='5' cols='30' name='promotion_desc' id=promotion_desc></textarea></td>
            </tr>
			
            <tr>
		<td width=70 height=57><font  size=2.5>Discount / Promo % :</font></td>
		<td><input type='text' name='promotion_pct' id=promotion_pct /></td>
            </tr>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new Discount or Promotion.</a></h1>

                        <div class="entry">
<?php echo $discountform; ?>
                        </div>
                    </div>
