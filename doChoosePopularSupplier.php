        ...
        <div id="wrapper">
           ...
           <div id="menu">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Viewing the top <?php echo $popular_amt; ?> Supplier Name.</a></h1>

                        <div class="entry">
                            <p>
                                Below are all the supplier name base on quantity sold.<br/>
...
while ($runrows = mysqli_fetch_array($run_consign_query))
{
 ...
 echo $supplierList = "<tr>
    ...
    {
    $noright = "You do not have the right to view this!";
    }
}
else
{
