...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    mysqli_query($connect, "DELETE FROM `promotion` WHERE promotion_id = '$promotion_id' ") or mysqli_error($connect);


    $deleted = "You have successfully deleted this promotion or discount.";
    }
else
    {
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Delete promotion / discount.</a></h1>
