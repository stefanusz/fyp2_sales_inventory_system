...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    $supplierform = "<form enctype='multipart/form-data' action='doNewSupplier.php' method=POST name='addsupplier'>
 
    <table width=473 border=0 cellpadding=10 cellspacing=2>
		
            <tr>
              <td width=70 height=57><font  size=2.5>Supplier Name:</font></td>
              <td width=275><input type='text' name ='supplier_name' id=supplier_name /></td>
            </tr>
			
            <tr>
              <td width=70 height=57><font  size=2.5>Supplier Email:</font></td>
              <td><input type='text' name='supplier_email' id=supplier_email /></td>
            </tr>
			
            <tr>
		<td width=70 height=57><font  size=2.5>Supplier Address:</font></td>
		<td><input type='text' name='supplier_add' id=supplier_add /></td>
            </tr>
            ...
            <tr>
              <td width=70 height=57><font  size=2.5>Consignment:</font></td>
              <td><input type='text' name='supplier_consignment' id=Supplier_consignment /></td>
            </tr>
    ...
    {
    $noright = "You do not have the right to enter a new Supplier.";
    }
?>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new Supplier.</a></h1>

                        <div class="entry">
<?php echo $supplierform; ?>
                        </div>
                    </div>
