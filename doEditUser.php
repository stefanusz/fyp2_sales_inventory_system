...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $role = strtolower(mysqli_real_escape_string($connect, strip_tags($_POST['role'])));
            ...
            mysqli_query($connect, "UPDATE  `user` SET  `username` =  '$username', `role` = '$role', `name` = '$name' WHERE `user_id` = '$user_id' ") or die(mysql_error());


            $success = "You succesfully update this particular user!";
