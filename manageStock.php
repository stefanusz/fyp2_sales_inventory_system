    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Managing the Stock in Dulcetfig.</a></h1>
                                ...
                                if(($_SESSION['role'] == 'admin') || ($_COOKIE['role'] == 'admin'))
                                    {
                                        ...
                                        <ul>
                                <li><a href='newSupplier.php'>Enter new supplier.</a></li><br/>
                                <li><a href='newBrand.php'>Enter a new brand.</a></li><br/>
                                <li><a href='newProduct.php'>Enter new product.</a></li><br/>
                                <li><a href='updateStockLevel.php'>Update stock level.</a></li>
