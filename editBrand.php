...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $BagForm = "<form enctype='multipart/form-data' action='doEditBrand.php' method=POST name='editbrand'>
...
<input type='hidden' value='$category_id' name='category_id'>
           ...
           <tr>
              ...
              <td width=275><input type='text' name ='brand_name' id=brand_name value='$brand_name' /></td>
            </tr>
