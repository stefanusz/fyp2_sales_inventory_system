...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $BagForm = "<form enctype='multipart/form-data' action='doProductForm.php' method=POST name='addBag'>
 <br/>With * is a compulsory field.
    <table width=550 border=0 cellpadding=10 cellspacing=2>
    
<input type='hidden' value='newBags' name='newBags'>
<input type='hidden' value=$brand_id name='category_id'>
		...
		<td><input type='text' name='circa' id=circa /></td>
            ...
            <tr>
              <td width=70 height=57><font  size=2.5>Height:</font></td>
              <td><input type='text' name='height' id=height /></td>
            </tr>
            
            <tr>
              <td width=70 height=57><font  size=2.5>Depth:</font></td>
              <td><input type='text' name='depth' id=depth /></td>
            </tr>
            
            <tr>
              <td width=70 height=57><font  size=2.5>Strap Length:</font></td>
              <td><input type='text' name='strap_length' id=strap_length /></td>
            </tr>
            
            <tr>
              <td width=70 height=57><font  size=2.5>Made In:</font></td>
              <td><input type='text' name='made_in' id=made_in /></td>
            </tr>
            
            <tr>
              <td width=70 height=57><font  size=2.5>Handle Length:</font></td>
              <td><input type='text' name='handle_length' id=handle_length /></td>
            </tr>
            
            <tr>
              <td width=70 height=57><font  size=2.5>Notes:</font></td>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new Bag.</a></h1>
