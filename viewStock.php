    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Viewing all the the different stock.</a></h1>
                        ...
                        <div class="entry">
                            ...
                            if((isset($_COOKIE['username'])) || (isset ($_SESSION['username'])))
                                ...
                                if(($_SESSION['role'] == 'admin') || ($_COOKIE['role'] == 'admin'))
                                    {
                                        $list = "Please choose which one you want to do below. <br/><br/>
                                        <ul>
                               <li><a href='viewAllSupplier.php'>View all the different Suppliers.</a></li><br/>
                               <li><a href='viewAllBrand.php'>View all the different Brands.</a></li><br/>
                               <li><a href='viewAll.php'>View all the different Products.</a></li><br/>
                               <li><a href='viewStockUpdate.php'>View all the stock update that happens.</a></li> <br/>
                               <li><a href='viewLowStock.php'>View product with low stock.</a></li> <br/>
                            </ul>";
                               ...
                               <li><a href='viewLowStock.php'>View product with low stock.</a></li> 
                            </ul>";
