...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $resetpassword = "<form enctype='multipart/form-data' action='doResetPassword.php' method=POST name='resetpassword'>
...
<input type='hidden' value='$user_id' name='user_id'>
        ...
        {
        $notadmin = "You're not an admin. You are not authorize to do this!";
        }
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Reset Password.</a></h1>
