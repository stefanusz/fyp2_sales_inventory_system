...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    ...
    mysqli_query($connect, "DELETE FROM `sales` WHERE vip_id = '$vip_id' ") or mysqli_error($connect);

    
    mysqli_query($connect, "DELETE FROM `customer` WHERE vip_id = '$vip_id' ") or mysqli_error($connect);



    $deleted = "You have successfully deleted this VIP member.";
    }
else
    {
