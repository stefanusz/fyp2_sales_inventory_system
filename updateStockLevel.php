...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Update of product inventory.</a></h1>

                        <div class="entry">
                            <p>
                               Please key-in the product code first
                            </p>
                            <?php
                            if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    {
    ...
    $product_code_form = "<form enctype='multipart/form-data' action='doUpdateStockLevel.php' method=POST name='updateOfStock'>
