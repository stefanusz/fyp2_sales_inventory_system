    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new product.</a></h1>
...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    // Provide link to go to view all of the product by category or supplier. 
    
    $links = "View all the different products by category or supplier.  <a href='viewAll.php'> Click here.</a>";
    echo $links;


    echo $brandform = "<form enctype='multipart/form-data' action='chooseProduct.php' method=POST name='chooseProduct'>
    ...
    echo "Click here to enter a new supplier. <a href=newSupplier.php>Click here.</a><br/><br/>
        Click here to enter a new brand. <a href=newBrand.php>Click here.</a><br/><br/>
        To enter a new Product. Please choose the brand of this product first.<br/><br/>
    ...
    echo '<select name=category_id>';
                                    while ($runrows = mysqli_fetch_array($runquery))
                                        ...
                                        echo "<option value= $category_id>  $namebrand  </option>";
                                        }
    echo '</select>';
