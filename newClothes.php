...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $newColthesform = "<form enctype='multipart/form-data' action='doProductForm.php' method=POST name='doProductForm'>
<br/>With * is a compulsory field.
    <table width=473 border=0 cellpadding=10 cellspacing=2>

    
    <input type='hidden' value='newClothes' name='newClothes'>
    <input type='hidden' value=$brand_id name='category_id'>
			...
			<tr>
              ...
              <td width=275><input type='text' name ='product_name' id=product_name /></td>
            </tr>
            ...
            <tr>
              ...
              <td width=275><input type='text' name ='waist' id=waist /></td>
            </tr>
            ...
            <tr>
                <td width=70 height=57><font  size=2.5>Waist To Crotch:</font></td>
		<td><input type='text' name='waist to crotch' id=waist to crotch /></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type='text' name='sleeve length' id=sleeve length /></td>
            </tr>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new clothes</a></h1>
