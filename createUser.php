...
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
{
    ...
    $formuser = "<form enctype='multipart/form-data' action='doCreateUser.php' method=POST name='adduser'>
    ...
    {
       header('Location: http://localhost/fyp2');
    exit; 
    }
?>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new User.</a></h1>
