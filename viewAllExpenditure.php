    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">View All the Expenditure.</a></h1>
                        <br/>
                        <br/>
                        <div class="entry">
                            ...
                            if (isset($_SESSION['username']) || isset($_COOKIE['username']))
                                ...
                                if (($_COOKIE['role'] == 'admin') || ($_SESSION['role'] == 'admin'))
                                    ...
                                    $headertable = "<table border= '2' cellpadding='4' cellspacing='2'>
                                            <tr>
                                            <th>ID</th>
                                            <th>Date [Y-M-D]</th>
                                            <th>Total Amount</th>
                                    ...
                                    while ($runrows = mysqli_fetch_array($runquery))
                                        ...
                                        $expenditure_id = $runrows['expenditure_id'];
                                        $date = $runrows['date'];
                                        ...
                                        $result = "<tr>
                                                    ...
                                                    <td>$date</td>
                                                    <td>$ $total_amount</td>
                                                    <td width=70 height=57><font  size=2.5><a href =detailExpenditure.php?expenditure_id=$expenditure_id >More details. </a></font></td>
                                                    <td width=70 height=57><font  size=2.5><a href =editExpenditure.php?expenditure_id=$expenditure_id >Edit this. </a></font></td>
                                                    <td width=70 height=57><font  size=2.5><a href =deleteExpenditure.php?expenditure_id=$expenditure_id onclick='return confirmDelete()' >Delete this. </a></font></td>
                                                    <td width=70 height=57><font  size=2.5><a href =printExpenditure.php?expenditure_id=$expenditure_id onclick='return confirmPrint()' >Print this. </a></font></td>
                                    ...
                                    {
                                    $notadmin = "You're not an admin and not authorize to view this.";
                                    }
                                }
                            else
                                {
