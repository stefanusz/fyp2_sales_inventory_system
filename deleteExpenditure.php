...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
 ...
 if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    mysqli_query($connect, "DELETE FROM `expenditure` WHERE expenditure_id = '$expenditure_id' ") or mysqli_error($connect);

    
   


    $deleted = "You have successfully deleted this expenditure.";
    }
else
    {
    ...
    $notadmin = "You have to be an admin to do this.";
     ...
     {
      $notlogin = "You are not log-in. Please log in first.";
     }
