...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Search of a VIP.</a></h1>

                        <div class="entry">
                            <p>
                               Please key-in the VIP number.
                            </p>
                            <?php
                            if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    {
    ...
    $vip_code_form = "<form enctype='multipart/form-data' action='doUpdateVIP.php' method=POST name='updateVIP'>
 
    <table width=473 border=0 cellpadding=10 cellspacing=2>

           <tr>
              <td width=70 height=57><font  size=2.5>VIP Number:</font></td>
              <td width=275><input type='text' name ='vip_number' id=vip_number /></td>
            </tr>
