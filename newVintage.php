...
if (isset($_SESSION['username']) || isset($_COOKIE['username']))
    ...
    $vintageform = "<form enctype='multipart/form-data' action='doProductForm.php' method=POST name='doProductForm'>
   <br/>With * is a compulsory field.
	  <table width=550 border=0 cellpadding=10 cellspacing=2>
		  
		  <input type='hidden' value='newVintage' name='newVintage'>
		  <input type='hidden' value=$brand_id name='category_id'>
			  ...
			  <tr>
			    ...
			    <td><input type='text' name='circa' id=circa /></td>
			  </tr>
			  ...
			  <tr>
				<td width=70 height=57><font  size=2.5>Marked Size:</font></td>
				<td><input type='text' name='marked_size' id=marked_size /></td>
			  </tr>
  
			  <tr>
				<td width=70 height=57><font  size=2.5>Estimated Size:</font></td>
				<td><input type='text' name='estimated_size' id=estimated_size /></td>
			  </tr>
			  
			  <tr>
				<td width=70 height=57><font  size=2.5>Fabric Content:</font></td>
				<td><input type='text' name='fabric_content' id=fabric_content /></td>
			  </tr>
		  
			  <tr>
				<td width=70 height=57><font  size=2.5>Shoulders:</font></td>
				<td><input type='text' name='shoulders' id=shoulders /></td>
			  </tr>
			  
			  <tr>
				<td width=70 height=57><font  size=2.5>Sleeve Length:</font></td>
				<td><input type='text' name='sleeve_length' id=sleeve_length /></td>
			  </tr>
			  
			  <tr>
				<td width=70 height=57><font  size=2.5>Bust:</font></td>
				<td><input type='text' name='bust' id=bust /></td>
			  </tr>
			  
			  <tr>
				<td width=70 height=57><font  size=2.5>waist:</font></td>
				<td><input type='text' name='waist' id=waist /></td>
			  </tr>
  
			  <tr>
				<td width=70 height=57><font  size=2.5>Hips:</font></td>
				<td><input type='text' name='hips' id=hips /></td>
			  </tr>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new Vintage Product.</a></h1>
