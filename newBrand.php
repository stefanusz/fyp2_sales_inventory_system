    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Add a new Brand.</a></h1>

                        <div class="entry">
                            <p>
                                Please enter the name of the brand into the field below.

<?php
if ($_SESSION['role'] == 'admin' || $_COOKIE['role'] == 'admin')
    {

    echo $brandform = "<form enctype='multipart/form-data' action='doNewBrand.php' method=POST name='addbrand'>
 
    <table width=600 border=0 cellpadding=10 cellspacing=2>
		
            <tr>
              <td width=70 height=57><font  size=2.5>Brand Name:</font></td>
              <td width=275><input type='text' name ='brand_name' id=brand_name /></td>
            </tr>";
    ...
    $header = "<tr>
              <td width=200 height=57><font  size=2.5>Please select which Supplier this brand belong to from below.</font></td>
    ...
    echo '<select name=supplier>';
                                    while ($runrows = mysqli_fetch_array($runquery))
                                        {
                                        $namebrand = $runrows['supplier_name'];
                                        $nameid = $runrows['supplier_id'];
