    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page">
                <div id="content">
                    <div class="post">
                        <h1 class="title"><a href="#">Sorting by all the different Supplier.</a></h1>
        ...
        <a href='viewSupplier.php'>Click here to sort by Supplier.</a>
             ";
                                    ...
                                    echo $brandform = "<form enctype='multipart/form-data' action='' method=POST name='viewSupplier'>
        <table width=473 border=0 cellpadding=10 cellspacing=2>";

                                    // calling out all the different brand.

                                    $supplier_query = "SELECT supplier_name, supplier_id from supplier ";
                                    $run_supplier_query = mysqli_query($connect, $supplier_query);
                                    $count_supplier_query = mysqli_num_rows($run_supplier_query);

                                    echo $message = "Please select below which supplier do you want to sort it by.<br/>";

                                    echo '<select name=supplier_name>';
                                    while ($runrows = mysqli_fetch_array($run_supplier_query))
                                        {
                                        $suppliername = $runrows['supplier_name'];
		...
		";
                                    ...
                                    if ($submit)
                                        ...
                                        $supplier_select = $_POST['supplier_name'];
...
AND s.supplier_id = '$supplier_select'";
